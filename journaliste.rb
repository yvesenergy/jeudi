...
puts "il ya #{tableau.count} journalistes" 


	c = 0	
tableau.each{ |x| (x.length).times {|y|
	b = x[y]
		if b.to_i.to_s == b
			c+=1
		break
...
puts "#{f} contiennent les 4 lettres du prénom Aude"
...
puts " #{s} commencent par une majuscule "
...
puts "#{j} contiennent des majuscules."
